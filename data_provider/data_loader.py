...
# dataset load in for BTD  
class Dataset_BTD(Dataset):
    # def __init__(self, args, root_path, flag='train', size=None,
    #              features='S', data_path='bones.txt',
    #              target='OT', scale=True, timeenc=0, freq='h', seasonal_patterns=None, augmentation_ratio=0):
    def __init__(self, args, root_path, flag='train', size=None, features='S', data_path='dataset/btd.txt',
                 target='OT', scale=True, timeenc=0, freq='h', augmentation_ratio=0, seasonal_patterns=None):
